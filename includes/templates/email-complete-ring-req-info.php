...
if ( $role === 'sender' ) {
	...
	gemfindrb_email_intro( 'Thank you for your interest in our Complete Ring.' );
	...
	gemfindrb_email_intro( sprintf( 'Customer interested in jewelcloud.com Complete Ring Setting#:%s', (string) ( $setting_id ?? '' ) ) );
